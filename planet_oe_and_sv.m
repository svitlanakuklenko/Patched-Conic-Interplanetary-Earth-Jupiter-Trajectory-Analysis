function[oe, r, v, jd] = planet_oe_and_sv(planet_id, year, month, day, hour, minute, second)

%   This function computes the orbital elements, the state vector, the velocity and the julian day for a planet. 
%   Based on Algorithm 8.1 from Orbital Mechanics for Engineering Students, 2010, by H.D. Curtis 
%
%   INPUTS: 
%        planet_id =  planet identifier - 1 to 3; 1 being Earth, 2 being Jupiter, and 3 being Europa
...
%% Calculate julian day at 0 hr universal time
...
%% Calculate mean anomaly and true anomaly
