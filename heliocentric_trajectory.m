function[planet1, planet2, trajectory] = heliocentric_trajectory(departure, arrival)
...
%   OUTPUTS: state vector and julian day for planet 1 and 2
...
[~, R_p1, V_p1, jd1] = planet_oe_and_sv(planet_id, year, month, day, hour, min, sec);
...
[~, R_p2, V_p2, jd2] = planet_oe_and_sv(planet_id, year, month, day, hour, min, sec);
