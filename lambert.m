...
%   Based on Algorithm 5.2 from Orbital mechanics for engineering students, 2010, by H.D. Curtis 
%
%   INPUTS: 
...
%Check where F(z,t) changes sign; use that value of z as a starting point 
z = -100;
while F(z,t) < 0
    z = z + 0.1;
end
