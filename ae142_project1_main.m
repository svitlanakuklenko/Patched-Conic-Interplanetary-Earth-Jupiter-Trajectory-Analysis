...
%% Focus on Patched Conic Trajectory Method
...
[oe1, r1, v1, ~] = planet_oe_and_sv(planet_id1, year1, month1,day1, hour1, min1, sec1);
[oe2, r2, v2, ~] = planet_oe_and_sv(planet_id2, year2, month2,day2, hour2, min2, sec2);

[oe1_prime, r1_prime, v1_prime, jd1_prime] = planet_oe_and_sv(planet_id1,year2, month2, day2, hour2, min2, sec2);
[oe2_prime, r2_prime, v2_prime, jd2_prime] = planet_oe_and_sv(planet_id2,year1, month1, day1, hour1, min1, sec1);
...
% Hyperbolic Departure Velocity v_inf 
vinf1 = V1 - Vp1;
...
planet1_astronomical_data = planetary_ephemeris(planet_id1);
% Radius of planet1
...
planet2_astronomical_data = planetary_ephemeris(planet_id2);
% Radius of planet2
...
plot3(r1_prime(1)/au,r1_prime(2)/au,r1_prime(3)/au,'ok','MarkerSize',7,'MarkerFaceColor','r');
plot3(r2_prime(1)/au,r2_prime(2)/au,r2_prime(3)/au,'ok','MarkerSize',7,'MarkerFaceColor','c');
