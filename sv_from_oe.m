...
%   This function computes the state vector using the classical orbital elements (oe).
%   Based on Algorithm 4.5 from Orbital mechanics for engineering students, 2010, by H.D. Curtis 
%
%   INPUTS:
